...
def parse_args(parse=True, **optional_kwargs):
    ...
    # Data Splits
    parser.add_argument("--dataset", type=str, default='m_IOATBC')
    ...
    parser.add_argument('--wandb_run_name', type=str, default="minor-HUM-small-baseline")
    parser.add_argument('--prompt_selection', type=int, default=0, help="Number of epochs")
    ...
    parser.add_argument('--save_by_step', type=int, default=10000, help='save model by step or epoch')
    ...
    parser.add_argument('--early_stop_step_num', type=int, default=5)
